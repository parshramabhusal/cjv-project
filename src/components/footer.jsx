            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-white sm:mb-0 dark:text-gray-400">
                        ...
                        <li>
                            <Link href="/movies" className="hover:underline me-4 md:me-6">Movies</Link>
                        </li>
                        <li>
                            <Link href="/shows" className="hover:underline me-4 md:me-6">Shows</Link>
                        </li>
                        <li>
                            <Link href="/signIn" className="hover:underline me-4 md:me-6">Sign In</Link>
                        </li>
                        <li>
